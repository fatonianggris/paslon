    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Regional Kecamatan </li>
            </ol>   
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Formulir Tambah Regional Kecamatan </h4>
                <h6 class="card-subtitle"> Silahkan mengisi formulir tambah regional kecamatan yang sesuai </h6>
                <form class="form-horizontal m-t-20 row" action="<?php echo site_url('regional/kirim_kecamatan'); ?>" enctype="multipart/form-data" method="post" novalidate>          
                    ...
                    <div class="form-group col-md-6 m-t-10">
                        ...
                        <fieldset class="controls">
                            <div class="input-group">                            
                                <input type="number" name="luas" class="form-control" min="1" placeholder="Isikan luas kecamatan" >
                                <div class="input-group-append">
                                    <span class="input-group-text">Angka</span>
                                </div>
                            </div>
