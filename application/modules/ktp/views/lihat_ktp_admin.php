...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Daftar Regional & Anggota</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Regional & Anggota</a></li>
                <li class="breadcrumb-item active">Daftar Regional & Anggota</li>
            </ol>
            <a href="<?php echo site_url('ktp/tambah_ktp_admin/' . $admin[0]->id_ref); ?>"> <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Tambah Anggota Admin</button></a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
        ...
        <div class="card">
            <div class="d-flex flex-row">
                ...
                <div class="align-self-center m-l-20">
                    <h3 class="m-b-0 text-info"><?php echo $count[0]->jml_ktp; ?></h3>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="card">
            <div class="d-flex flex-row">
                ...
                <div class="align-self-center m-l-20">
                    <h3 class="m-b-0 text-success"><?php echo $count[0]->jml_reg; ?></h3>
...
<div class="row">
    <div class="col-12">    
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Daftar Semua Anggota "<?php echo ucwords($admin[0]->nama_admin); ?>"</h4>
                ...
                <a href="<?php echo site_url('laporan/cetak_laporan_admin/' . $admin[0]->id_ref); ?>" target="_blank" > 
                ...
                <form class="pull-right" id="frm-kta-ktp" target="_blank" action="<?php echo site_url('laporan/cetak_kta_admin/' . $admin[0]->id_ref); ?>" method="POST">  
                ...
                <form class="pull-right" id="frm-ktp" target="_blank" action="<?php echo site_url('laporan/cetak_kta_only_admin/' . $admin[0]->id_ref); ?>" method="POST">  
                ...
                <a href="<?php echo site_url('ktp/zip_all_ktp'); ?>" > 
                    <button type="button" class="btn waves-effect waves-light btn-xs btn-warning pull-right" style="margin-right: 10px;"><i class="fa fa-compress"></i> Arsipkan KTP.zip</button>
                </a>    
                <a href="<?php echo site_url('ktp/export_csv_admin/' . $admin[0]->id_ref); ?>" > 
                    <button type="button" class="btn waves-effect waves-light btn-xs btn-warning pull-right" style="margin-right: 10px;"><i class="fa fa-file-text"></i> Export Data Admin.csv</button>
                </a>
                <div class="table-responsive m-t-10">
                    ...
                    <form class="form-horizontal row m-b-10" id="frm-excel" target="_blank" action="<?php echo site_url('ktp/export_laporan'); ?>" method="POST">  
                        ...
                        <div class="col-md-8">
                            ...
                            <small class="form-control-feedback">*Export checkbox</small>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">                  
                    <div class="card text-center">
                        <div class="card-body">
                            <h4 class="card-title text-danger">HARAP HATI-HATI KETIKA MENGHAPUS DATA REGIONAL !!!</h4>
                            <p class="card-text">Diharapkan berhati-hati ketika <b>MENGHAPUS</b> data Regional, dikarenakan semua data Anggota yang berada pada Regional tersebut akan terhapus. Disarankan untuk <b>MENGGANTI</b> Regional Anggota terlebih dahulu sebelum menghapus data Regional.</p>
                            <p class="card-text"><b> Terima Kasih... </b></p>
                            <a href="" class="btn btn-info" data-dismiss="modal">TUTUP</a>      
                            <a href="<?php echo site_url('ktp/ktp'); ?>" class="btn btn-warning">KE DAFTAR Anggota</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="import" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('ktp/upload_csv_admin/' . $admin[0]->id_ref); ?>" enctype="multipart/form-data" method="post">
                <div class="modal-body">                  
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-12 text-left">
                                ...
                                <select name="region_anggota" class="select2 form-control custom-select" style="width: 100%; height:36px;" required="" data-validation-required-message="Kolom ini wajib diisi!" id="region_anggota">
                                    <?php
                                    if (!empty($admin_regional) && $admin[0]->id_ref != null) {
                                        foreach ($admin_regional as $key => $value) {
                                            if ($value->id_ref == $admin[0]->id_ref) {
                                                ?>
                                                <option value="<?php echo $admin[0]->id_ref; ?>" selected="">
                                    ...
                                    ?>
                                    <?php if (empty($admin[0]->id_ref) or $admin[0]->id_ref == 0) {
                                        ?>
                            ...
                            <div class="form-group col-md-12 text-left m-t-5">
...
<div id="mutasi" class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('mutasi/mutasi_anggota_admin'); ?>" enctype="multipart/form-data" method="post">
                <div class="modal-body">                  
                    <div class="card text-center">
                        <div class="card-body">                               
                            <div class="form-group col-md-12 text-left">
                            ...
                            <div class="form-group col-md-12 m-t-5 text-left">
                                ...
                                <input type="hidden" name="id_url" value="<?php echo $admin[0]->id_ref; ?>" class="form-control">
...
<script>
    $(document).ready(function () {
        ...
        var table2 = $('#tabel_ktp2').DataTable({
            ...
            //"serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('datatable/datatable/ktp_reg_json/' . $admin[0]->id_ref); ?>',
                "type": "POST"
            },
...
<script>
    ...
    function update_content() {
        var url = "<?php echo site_url('ktp/add_ajax_petugas'); ?>/" + <?php echo $admin[0]->id_ref ?>;
