    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Formulir Edit Anggota</h4>
                <h6 class="card-subtitle"> Silahkan mengisi formulir Edit Anggota yang sesuai </h6>
                <form class="form-horizontal m-t-20 row" action="<?php echo site_url('ktp/edit_ktp/' . $ktp[0]->id_ktp); ?>" enctype="multipart/form-data" method="post" novalidate>          
                    ...
                    <div class="form-group col-md-6 m-t-10">
                        ...
                        <fieldset class="controls">
                            <input type="text" name="alamat_ktp" class="form-control" value="<?php echo $ktp[0]->alamat_ktp; ?>" placeholder="Isikan Alamat ID anggota" required data-validation-required-message="Kolom ini wajib diisi!">     
                        </fieldset>
                    </div>
                    <div class="form-group col-md-2 m-t-10">
                        ...
                        <fieldset class="controls">
                            <div class="input-group">                            
                                <input type="text" name="rt" data-mask="9999" class="form-control" value="<?php echo $ktp[0]->rt; ?>" placeholder="Isikan RT" required  data-validation-required-message="Kolom ini wajib diisi!">
                                <div class="input-group-append">
                    ...
                    <div class="form-group col-md-2 m-t-10">
                        ...
                        <fieldset class="controls">
                            <div class="input-group">                            
                                <input type="text" name="rw" data-mask="9999" class="form-control" value="<?php echo $ktp[0]->rw; ?>" placeholder="Isikan RW" required  data-validation-required-message="Kolom ini wajib diisi!">
                                <div class="input-group-append">
                    ...
                    <div class="form-group col-md-2 m-t-10">
                        ...
                        <fieldset class="controls">
                            <div class="input-group">                            
                                <input type="text" name="kodepos" data-mask="99999" class="form-control" value="<?php echo $ktp[0]->kodepos; ?>" placeholder="Isikan Kodepos" >                         
                            </div>
                        </fieldset>
                    </div>
                    <div class="form-group col-md-3 m-t-10">
                    ...
                    <div class="form-group col-md-2 m-t-5">
                        ...
                        <fieldset class="controls">
                            <div class="custom-control custom-radio m-t-10" required data-validation-required-message="Kolom ini wajib diisi!">
                    ...
                    <div class="form-group col-md-6 m-t-10">
                        ...
                        <div class="input-group">                            
                            <input type="text" onkeyup="checkNikRealTime(this.value)" data-mask="99999999999999999999999"  value="<?php echo $ktp[0]->nik_kta_lama; ?>" name="nik_kta_lama" class="form-control" placeholder="Isikan nomor KTA lama">
                            <div class="input-group-append">
                                <span class="input-group-text">Angka</span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-6 m-t-10">
                        ...
                        <div class="input-group">                            
                            <input type="text" onkeyup="checkNikRealTime(this.value)" data-mask="99999999999999999999999"  value="<?php echo $ktp[0]->nik_kta_baru; ?>" class="form-control" disabled="">
                            <div class="input-group-append">
                                <span class="input-group-text">Angka</span>
                            </div>
                        </div>
                    ...
                    <div id="pengurus">
                        ...
                        <div class="form-group col-md-3 m-t-10">
                            ...
                            <select name="provinsi_peng" class="select2 form-control custom-select" style="width: 100%; height:36px;" id="provinsi_peng" >
                                <option value="<?php echo substr($ktp[0]->wilayah_pengurus, 0, 2); ?>" selected>
                                    <?php
                                    if (!empty($prov)) {
                                        foreach ($prov as $key => $value) {
                        ...
                        <div class="form-group col-md-3 m-t-10">
                            ...
                            <select name="kabupaten_peng" class="select2 form-control custom-select" style="width: 100%; height:36px;" id="kabupaten_peng" >
                                <option value="<?php echo substr($ktp[0]->wilayah_pengurus, 2, 2); ?>" selected>
                                    <?php
                                    if (!empty($kab)) {
                                        foreach ($kab as $key => $value) {
                        ...
                        <div class="form-group col-md-3 m-t-10">
                            ...
                            <select name="kecamatan_peng" class="select2 form-control custom-select" style="width: 100%; height:36px;" id="kecamatan_peng" >
                                <option value="<?php echo substr($ktp[0]->wilayah_pengurus, 4, 2); ?>" selected>
                                    <?php
                                    if (!empty($kec)) {
                                        foreach ($kec as $key => $value) {
                        ...
                        <div class="form-group col-md-3 m-t-10" >
                            ...
                            <select name="kelurahan_peng" class="select2 form-control custom-select" style="width: 100%; height:36px;" id="kelurahan_peng" >
                                <option value="<?php echo substr($ktp[0]->wilayah_pengurus, 6, 2); ?>" selected>
                                    <?php
                                    if (!empty($kel)) {
                                        foreach ($kel as $key => $value) {
