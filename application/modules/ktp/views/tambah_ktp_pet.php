...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Tambah Anggota Petugas</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Anggota</a></li>
                <li class="breadcrumb-item active">Tambah Anggota Petugas</li>
            </ol>
            <a href="<?php echo site_url('ktp/lihat_ktp_pet/' . $pet[0]->id_petugas); ?>"> <button type="button" class="btn btn-warning d-none d-lg-block m-l-15"><i class="fa fa-list-ol"></i> Daftar Anggota Petugas</button></a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Formulir Tambah Anggota Petugas "<?php echo ucwords($pet[0]->nama_petugas); ?>"</h4>
                <h6 class="card-subtitle"> Silahkan mengisi formulir tambah Anggota Petugas yang sesuai </h6>
                <form class="form-horizontal m-t-20 row" action="<?php echo site_url('ktp/kirim_ktp_pet/' . $pet[0]->id_petugas); ?>" enctype="multipart/form-data" method="post" novalidate>          
                    ...
                    <div class="form-group col-md-3 m-t-10">
                        ...
                        <fieldset class="controls">
                            <select name="nama_petugas" class="select2 form-control custom-select" style="width: 100%; height:36px;" id="nama_petugas" required data-validation-required-message="Kolom ini wajib diisi!">
                                <option selected value="<?php echo $pet[0]->id_petugas; ?>"><?php echo ucwords($pet[0]->nama_petugas); ?></option>              
                            </select>
                        </fieldset>
                    </div>
                    <div class="form-group col-md-2 m-t-10">
