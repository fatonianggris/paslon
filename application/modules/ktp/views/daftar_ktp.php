                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-12 text-left">
                                    ...
                                    <select name="region_anggota" class="select2 form-control custom-select" style="width: 100%; height:36px;" required="" data-validation-required-message="Kolom ini wajib diisi!" id="region_anggota">
                                        <option>Pilih region pemungutan</option>
                                        <?php
    ...
    <div id="mutasi" class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('mutasi/mutasi_anggota'); ?>" enctype="multipart/form-data" method="post">
                    <div class="modal-body">                  
                        <div class="card text-center">
                            <div class="card-body">                               
                                <div class="form-group col-md-12 text-left">
...
<script>
    $(document).ready(function () {
        ...
        var table2 = $('#tabel_ktp2').DataTable({
            ...
            //"serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('datatable/datatable/ktp_json'); ?>',
                "type": "POST"
            },
