    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Anggota per Petugas</li>
            </ol>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Formulir Edit Anggota per Petugas "<?php echo ucwords($pet[0]->nama_petugas); ?>"</h4>
                <h6 class="card-subtitle"> Silahkan mengisi formulir Edit Anggota per Petugas yang sesuai </h6>
                <form class="form-horizontal m-t-20 row" action="<?php echo site_url('ktp/edit_ktp_pet/' . $ktp[0]->id_ktp); ?>" enctype="multipart/form-data" method="post" novalidate>          
                    ...
                    <div class="form-group col-md-3 m-t-10">
                        ...
                        <div class="input-group">                            
                            <input type="text" name="nomor_rumah_ktp" value="<?php echo $ktp[0]->nomor_rumah_ktp; ?>" data-mask="0000-0000-000000" class="form-control" placeholder="Isikan nomor tlp rumah">
                            <div class="input-group-append">
                                <span class="input-group-text">Angka</span>
                            </div>
                        </div>
