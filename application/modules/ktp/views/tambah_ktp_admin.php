...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Tambah Anggota Admin</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Anggota</a></li>
                <li class="breadcrumb-item active">Tambah Anggota Admin</li>
            </ol>
            <a href="<?php echo site_url('ktp/lihat_ktp_admin/' . $admin[0]->id_ref); ?>"> <button type="button" class="btn btn-warning d-none d-lg-block m-l-15"><i class="fa fa-list-ol"></i> Daftar Anggota Admin</button></a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Formulir Tambah Anggota Admin "<?php echo ucwords($admin[0]->nama_admin); ?>"</h4>
                <h6 class="card-subtitle"> Silahkan mengisi formulir tambah Anggota Admin yang sesuai </h6>
                <form class="form-horizontal m-t-20 row" action="<?php echo site_url('ktp/kirim_ktp_admin/' . $admin[0]->id_ref); ?>" enctype="multipart/form-data" method="post" novalidate>          
                    <div class="form-group col-md-6 m-t-10">
                        <label>Nama ID <span class="text-danger">*</span></label>
                        <fieldset class="controls">
                            <input type="text" name="nama_ktp" class="form-control" placeholder="Isikan nama anggota" required data-validation-required-message="Kolom ini wajib diisi!">
                        </fieldset>
                    </div>                   
                    <div class="form-group col-md-6 m-t-10">
                        ...
                        <fieldset class="controls">
                            <div class="input-group">                            
                                <input type="text" onkeyup="checkNikRealTime(this.value)" name="nik_ktp" data-mask="9999999999999999"  class="form-control" placeholder="Isikan No Identitas" required  data-validation-required-message="Kolom ini wajib diisi!">
                    ...
                    <div class="form-group col-md-2 m-t-5">
                        ...
                        <fieldset class="controls">
                            <div class="custom-control custom-radio m-t-10">
                                <input type="radio" id="jk1" value="1" name="jenis_kelamin" class="custom-control-input" required data-validation-required-message="Kolom ini wajib diisi!">
                    ...
                    <div class="form-group col-md-6 m-t-10">
                        ...
                        <fieldset class="controls">
                            <input type="text" name="alamat_ktp" class="form-control" placeholder="Isikan Alamat ID Anggota" required data-validation-required-message="Kolom ini wajib diisi!">     
                        </fieldset>
                    </div>
                    <div class="form-group col-md-2 m-t-10">
                    ...
                    <div class="form-group col-md-2 m-t-5">
                        ...
                        <fieldset class="controls">
                            <div class="custom-control custom-radio m-t-10">
                                <input type="radio" id="kawin1" value="0" name="status_nikah" class="custom-control-input" required data-validation-required-message="Kolom ini wajib diisi!">
                    ...
                    <div class="form-group col-md-3 m-t-10">
                        ...
                        <fieldset class="controls">
                            <select name="region_anggota" class="select2 form-control custom-select" readonly style="width: 100%; height:36px;" id="region_anggota" required data-validation-required-message="Kolom ini wajib diisi!">
                                <option value="<?php echo $admin[0]->id_ref; ?>" selected>
                                    <?php echo strtoupper($admin[0]->provinsi); ?>
                                    <?php
                                    if ($admin[0]->kabupaten != NULL) {
                                        echo ' - ' . strtoupper($admin[0]->kabupaten);
                                    }
                                    ?>                                
                                </option>
                            </select>
...
<script>
    ...
    $(function () {
        var sel_imie = $('select[name="id_pemula"]')
        sel_imie.prop('disabled', true);
        $('select[name ="tipe_id"]').change(function () {
            if ($(this).val() == 4) {
                sel_imie.prop('disabled', false);
            } else {
                sel_imie.prop('disabled', true);
                sel_imie.prop('selectedIndex', 0)
            }
        });
    });
