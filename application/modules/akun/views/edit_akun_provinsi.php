...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Edit Admin Provinsi</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Admin Provinsi</a></li>
                <li class="breadcrumb-item active">Edit Admin Provinsi</li>
            </ol> 
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Formulir Edit Admin Provinsi</h4>
                <h6 class="card-subtitle"> Silahkan mengisi formulir edit admin provinsi yang sesuai </h6>
                <form class="form-horizontal m-t-20 row" action="<?php echo site_url('akun/edit_admin_provinsi/' . $admin_provinsi[0]->id_user); ?>" enctype="multipart/form-data" method="post">          
                    <div class="form-group col-md-6 m-t-10" >
                        <label>Nama Lengkap Admin Provinsi <span class="text-danger">*</span></label>
                        <input type="text" name="nama_admin" value="<?php echo $admin_provinsi[0]->nama_admin; ?>" class="form-control" placeholder="Isikan nama lengkap admin" required data-validation-required-message="Kolom ini wajib diisi">
                    ...
                    <div class="form-group col-md-3 m-t-10">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="create" value="1" class="custom-control-input" id="customCheck1" <?php echo ($admin_provinsi[0]->create_prev ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group col-md-3 m-t-10">
                        <label></label>                        
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="update" value="1" class="custom-control-input" id="customCheck3" <?php echo ($admin_provinsi[0]->update_prev ? 'checked' : ''); ?>>
                            <label class="custom-control-label" for="customCheck3">Update</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="delete"value="1" class="custom-control-input" id="customCheck4" <?php echo ($admin_provinsi[0]->delete_prev ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group col-md-6 m-t-10" >
                        ...
                        <input type="email" name="email" value="<?php echo $admin_provinsi[0]->email; ?>" class="form-control" placeholder="Isikan email admin provinsi" required data-validation-required-message="Kolom ini wajib diisi">
                        <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b> ! </small>
                    </div>
                    <div class="form-group col-md-6 m-t-10">
                        <label>Nomor HP Admin Provinsi<span class="text-danger">*</span></label>
                        <div class="input-group">                            
                            <input type="text" name="nomor_hp" value="<?php echo $admin_provinsi[0]->nomor_hp; ?>" class="form-control" data-mask="00000000000000" placeholder="Isikan nomor HP admin provinsi" required data-validation-required-message="Kolom ini wajib diisi">
                    ...
                    <div class="form-group col-md-2 m-t-5">
                        ...
                        <div class="custom-control custom-radio m-t-10">
                            <input type="radio" id="sts1" value="1" name="status" class="custom-control-input"  <?php echo ($admin_provinsi[0]->status == '1') ? 'checked' : '' ?>>
                            <label class="custom-control-label" for="sts1">Aktif</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="sts2" value="0" name="status" class="custom-control-input"  <?php echo ($admin_provinsi[0]->status == '0') ? 'checked' : '' ?>>
                    ...
                    <div class="form-group col-md-5 m-t-10">
                        ...
                        <select name="provinsi" class="select2 form-control custom-select" style="width: 100%; height:36px;" id="provinsi" required>
                            <option value="<?php echo substr($admin_provinsi[0]->id_ref, 0, 2); ?>">
                                <?php
                                if (!empty($prov)) {
                                    foreach ($prov as $key => $value) {
                                        if ($value->id == substr($admin_provinsi[0]->id_ref, 0, 2)) {
                                            ?>
                                            <?php echo $value->nama; ?>                                    
                                            <?php
                                        }
                    ...
                    <div class="form-group col-md-5 m-t-10">
                        ...
                        <div class="input-group">
                            <input type="text" name="license_exp" class="form-control" value="<?php echo $admin_provinsi[0]->license_exp; ?>" placeholder="Tanggal Expired" id="license_date" required data-validation-required-message="Kolom ini wajib diisi!">                          
                        </div>
                        <small class="form-control-feedback">
                            <?php if ($admin_provinsi[0]->license_exp == NULL or $admin_provinsi[0]->license_exp == '') { ?>
                            ...
                            <?php } else { ?>
                                ...
                                $date = DateTime::createFromFormat('d/m/Y', $admin_provinsi[0]->license_exp);
                    ...
                    <div class="form-group col-md-12 m-t-5">
                        ...
                        <div class="input-group"> 
                            <textarea class="form-control" rows="5" name="license" ><?php echo $admin_provinsi[0]->license; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-12 m-t-10">
                        <label>Foto Admin Provinsi</label>
                        <input type="text" name="image" value="<?php echo $admin_provinsi[0]->img ?>" style="display:none" />
                        <input type="text" name="image_thumb" value="<?php echo $admin_provinsi[0]->img_thumb; ?>" style="display:none" />
                        <input type="file" name="img" class="dropify" data-max-file-size="1M" data-height="300" data-allowed-file-extensions="jpg png jpeg ico" data-default-file="<?php echo base_url() . $admin_provinsi[0]->img ?>"/>
