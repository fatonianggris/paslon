...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Tambah Calon Pemilihan</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)"> Calon Pemilihan</a></li>
                <li class="breadcrumb-item active">Tambah Calon Pemilihan</li>
            </ol>        
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Tambah Calon Pemilihan</h4>
                <h6 class="card-subtitle">Tambah calon pemilihan terkait nama calon, no urut dll</h6>               
                <form class="form-horizontal m-t-10 row" action="<?php echo site_url('pemilihan/kirim_calon_pemilihan/' . $pemilihan[0]->id_pemilihan); ?>" enctype="multipart/form-data" method="post">          
                    <div class="col-md-12 row">
                        <div class="form-group col-md-2 m-t-5">
                            <label>Nomor Urut<span class="text-danger">*</span></label>
                            <fieldset class="controls">
                                <input type="number" min="0" name="nomor_urut_awal" class="form-control" placeholder="Isikan nomor urut" required data-validation-required-message="Kolom ini wajib diisi">
                            </fieldset>
                        ...
                        <div class="form-group col-md-5 m-t-5" >
                            ...
                            <fieldset class="controls">
                                <input type="text" name="nama_calon_awal" class="form-control" placeholder="Isikan calon" required data-validation-required-message="Kolom ini wajib diisi">
                            </fieldset>
                        ...
                        <div class="form-group col-md-5 m-t-5" >
                            ...
                            <fieldset class="controls">
                                <input type="text" name="nama_wakil_calon_awal" class="form-control" placeholder="Isikan wakil calon" >
                            </fieldset>                           
                        </div>
                    </div>
