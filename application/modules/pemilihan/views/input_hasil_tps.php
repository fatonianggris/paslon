...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Hasil Pemilihan</h4>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card card-body">
                <h4 class="card-title">Hasil TPS "<?php echo strtoupper($tps[0]->nama_tps); ?>-<?php echo strtoupper($tps[0]->nomor_tps); ?>"</h4>
                <h6 class="card-subtitle">Hasil TPS terkait data pemilih, data hak pilih dll</h6>               
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-12 row ">
                            ...
                            <div class="form-group col-md-3  " >
                                ...
                                <input type="number" min="0" name="dp_dpt_laki_laki" id="id_dp_dpt_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                            ...
                            <div class="form-group col-md-3  " >
                                ...
                                <input type="number" min="0" name="dp_dpt_perempuan" id="id_dp_dpt_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b> </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dpph_laki_laki" id="id_dp_dpph_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dpph_perempuan" id="id_dp_dpph_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dptb_laki_laki" id="id_dp_dptb_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dptb_perempuan" id="id_dp_dptb_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row ">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpt_laki_laki" id="id_php_dpt_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpt_perempuan" id="id_php_dpt_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpph_laki_laki" id="id_php_dpph_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpph_perempuan" id="id_php_dpph_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>   </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3 " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dptb_laki_laki" id="id_php_dptb_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3 " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dptb_perempuan" id="id_php_dptb_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                                ...
                                <table class="table table-no-bordered no-border text-center table-pemilihan">
                                            ...
                                            foreach ($calon_pemilihan as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        ...
                                                        <input type="number" min="0" name="suara_sah[]" class="form-control id_suara_sah" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi">
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
                                    ...
                                    <tfoot>
                                        <tr class="center align-center"> 
                                            ...
                                            <th>
                                                <input type="number" min="0" name="total_suara_sah" id="id_total_suara_sah" class="form-control" placeholder="Jumlah suara sah" required data-validation-required-message="Kolom ini wajib diisi" readonly>                    
                                            </th>                                           
                                        </tr>
                                    </tfoot>
                                    <tfoot>
                                        <tr class="center align-center"> 
                                            ...
                                            <th>
                                                <input type="number" min="0" name="total_suara_tidak_sah" class="form-control" placeholder="Jumlah suara tidak sah" required data-validation-required-message="Kolom ini wajib diisi">                    
                                            </th>                                           
                                        </tr>
                                    </tfoot>
                                </table>
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-6 card">
                            <div class="card-body">
                                ...
                                <input type="file" name="fotoc1_pertama" class="dropify" data-max-file-size="4M" data-height="300"  data-allowed-file-extensions="jpg png jpeg ico"/>
                            </div>
                        </div>
                        <div class="col-md-6 card">
                            <div class="card-body">
                                <label> <b>Foto Formulir C1 Ke-2 </b><span class="text-danger">*</span></label>
                                <input type="file" name="fotoc1_kedua" class="dropify" data-max-file-size="4M" data-height="300"  data-allowed-file-extensions="jpg png jpeg ico"/>
                            </div>
                        </div>
                    </div>
