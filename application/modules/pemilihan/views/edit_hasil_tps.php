...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Edit Hasil Pemilihan</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)"> Hasil Pemilihan</a></li>
                <li class="breadcrumb-item active">Edit Hasil Pemilihan</li>
            </ol>        
    ...
    <div class="col-12">
        <div class="card">
            <div class="card card-body">
                ...
                <h4 class="card-title">Edit Hasil TPS "<?php echo strtoupper($tps[0]->nama_tps); ?>-<?php echo strtoupper($tps[0]->nomor_tps); ?>"</h4>
                <h6 class="card-subtitle">Edit hasil TPS terkait data pemilih, data hak pilih dll</h6>               
                <form class="form-horizontal m-t-10 row" action="<?php echo site_url('pemilihan/edit_hasil_pemilihan/' . $tps[0]->id_tps . '/' . $pemilihan[0]->id_pemilihan . '/' . $nama_wilayah[0]->id_wilayah); ?>" enctype="multipart/form-data" method="post">                             
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-12 row ">
                            ...
                            <div class="form-group col-md-3  " >
                                ...
                                <input type="number" min="0" name="dp_dpt_laki_laki" value="<?php echo $get_hasil_pemilihan[0]->dp_dpt_laki_laki; ?>" id="id_dp_dpt_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                            ...
                            <div class="form-group col-md-3  " >
                                ...
                                <input type="number" min="0" name="dp_dpt_perempuan" value="<?php echo $get_hasil_pemilihan[0]->dp_dpt_perempuan; ?>" id="id_dp_dpt_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b> </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dpph_laki_laki" value="<?php echo $get_hasil_pemilihan[0]->dp_dpph_laki_laki; ?>" id="id_dp_dpph_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>  </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dpph_perempuan" value="<?php echo $get_hasil_pemilihan[0]->dp_dpph_perempuan; ?>" id="id_dp_dpph_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" > 
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dptb_laki_laki" value="<?php echo $get_hasil_pemilihan[0]->dp_dptb_laki_laki; ?>"  id="id_dp_dptb_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="dp_dptb_perempuan" value="<?php echo $get_hasil_pemilihan[0]->dp_dptb_perempuan; ?>" id="id_dp_dptb_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row ">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpt_laki_laki" value="<?php echo $get_hasil_pemilihan[0]->php_dpt_laki_laki; ?>" id="id_php_dpt_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpt_perempuan" value="<?php echo $get_hasil_pemilihan[0]->php_dpt_perempuan; ?>" id="id_php_dpt_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpph_laki_laki" value="<?php echo $get_hasil_pemilihan[0]->php_dpph_laki_laki; ?>" id="id_php_dpph_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3  " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dpph_perempuan" value="<?php echo $get_hasil_pemilihan[0]->php_dpph_perempuan; ?>" id="id_php_dpph_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>   </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-3 " >
                                <label>Laki-Laki <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dptb_laki_laki" value="<?php echo $get_hasil_pemilihan[0]->php_dptb_laki_laki; ?>" id="id_php_dptb_laki_laki" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                            ...
                            <div class="form-group col-md-3 " >
                                <label>Perempuan <span class="text-danger">*</span></label>
                                <input type="number" min="0" name="php_dptb_perempuan" value="<?php echo $get_hasil_pemilihan[0]->php_dptb_perempuan; ?>" id="id_php_dptb_perempuan" class="form-control" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                <small class="form-control-feedback">*Kolom Ini Harus <b>Diisi</b>    </small>
                            </div>
                            <div class="form-group col-md-1">
                                <label></label>
                                ...
                                <table class="table table-no-bordered no-border text-center table-pemilihan">
                                            ...
                                            foreach ($suara_calon as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        ...
                                                        <input type="text" name="id_suara_calon[]" value="<?php echo $value->id_suara_calon; ?>" style="display:none" />
                                                        <input type="number" min="0" name="suara_sah[]" value="<?php echo $value->suara_sah; ?>" class="form-control id_suara_sah" placeholder="Isikan nominal suara" required data-validation-required-message="Kolom ini wajib diisi" >
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
                                    ...
                                    <tfoot>
                                        <tr class="center align-center"> 
                                            ...
                                            <th>
                                                <input type="number" min="0" value="<?php echo $get_hasil_pemilihan[0]->total_suara_tidak_sah; ?>" name="total_suara_tidak_sah" class="form-control" placeholder="Jumlah suara tidak sah" required data-validation-required-message="Kolom ini wajib diisi" >                    
                                            </th>                                           
                                        </tr>
                                    </tfoot>
                                </table>
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-6 card">
                            <div class="card-body">
                                ...
                                <input type="text" name="fotoc1_pertama_temp" value="<?php echo $get_hasil_pemilihan[0]->fotoc1_pertama ?>" style="display:none" />
                                <input type="text" name="fotoc1_pertama_temp_thumb" value="<?php echo $get_hasil_pemilihan[0]->fotoc1_pertama_thumb; ?>" style="display:none" />
                                <input type="file" name="fotoc1_pertama" class="dropify" data-default-file="<?php echo base_url() . $get_hasil_pemilihan[0]->fotoc1_pertama_thumb ?>" data-max-file-size="4M" data-height="300"  data-allowed-file-extensions="jpg png jpeg ico" />
                            </div>
                        </div>
                        <div class="col-md-6 card">
                            <div class="card-body">
                                <label> <b>Foto Formulir C1 Ke-2 </b><span class="text-danger">*</span></label>
                                <input type="text" name="fotoc1_kedua_temp" value="<?php echo $get_hasil_pemilihan[0]->fotoc1_kedua ?>" style="display:none" />
                                <input type="text" name="fotoc1_kedua_temp_thumb" value="<?php echo $get_hasil_pemilihan[0]->fotoc1_kedua_thumb; ?>" style="display:none" />
                                <input type="file" name="fotoc1_kedua" class="dropify" data-default-file="<?php echo base_url() . $get_hasil_pemilihan[0]->fotoc1_kedua_thumb ?>" data-max-file-size="4M" data-height="300"  data-allowed-file-extensions="jpg png jpeg ico" />
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('#id_dp_dpt_laki_laki').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_dp_dpt_perempuan').val());
        if ($(this).val().length) {
            $('input[id="id_dp_dpt_jumlah"]').val(count);
            trigger_total_dp();
        } else {
            $('input[id="id_dp_dpt_jumlah"]').val(count);
            trigger_total_dp();
    ...
    $('#id_dp_dpt_perempuan').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_dp_dpt_laki_laki').val());
        if ($(this).val().length) {
            $('input[id="id_dp_dpt_jumlah"]').val(count);
            trigger_total_dp();
        } else {
    ...
    $('#id_dp_dpph_laki_laki').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_dp_dpph_perempuan').val());
        if ($(this).val().length) {
            $('input[id="id_dp_dpph_jumlah"]').val(count);
            trigger_total_dp();
        } else {
            $('input[id="id_dp_dpph_jumlah"]').val(count);
            trigger_total_dp();
    ...
    $('#id_dp_dpph_perempuan').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_dp_dpph_laki_laki').val());
        if ($(this).val().length) {
            $('input[id="id_dp_dpph_jumlah"]').val(count);
            trigger_total_dp();
        } else {
    ...
    $('#id_dp_dptb_laki_laki').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_dp_dptb_perempuan').val());
        if ($(this).val().length) {
            $('input[id="id_dp_dptb_jumlah"]').val(count);
            trigger_total_dp();
        } else {
            $('input[id="id_dp_dptb_jumlah"]').val(count);
            trigger_total_dp();
    ...
    $('#id_dp_dptb_perempuan').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_dp_dptb_laki_laki').val());
        if ($(this).val().length) {
            $('input[id="id_dp_dptb_jumlah"]').val(count);
            trigger_total_dp();
        } else {
...
<script>
    $('#id_php_dpt_laki_laki').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_php_dpt_perempuan').val());
        if ($(this).val().length) {
            $('input[id="id_php_dpt_jumlah"]').val(count);
            trigger_total_php();
        } else {
            $('input[id="id_php_dpt_jumlah"]').val(count);
            trigger_total_php();
    ...
    $('#id_php_dpt_perempuan').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_php_dpt_laki_laki').val());
        if ($(this).val().length) {
            $('input[id="id_php_dpt_jumlah"]').val(count);
            trigger_total_php();
        } else {
    ...
    $('#id_php_dpph_laki_laki').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_php_dpph_perempuan').val());
        if ($(this).val().length) {
            $('input[id="id_php_dpph_jumlah"]').val(count);
            trigger_total_php();
        } else {
            $('input[id="id_php_dpph_jumlah"]').val(count);
            trigger_total_php();
    ...
    $('#id_php_dpph_perempuan').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_php_dpph_laki_laki').val());
        if ($(this).val().length) {
            $('input[id="id_php_dpph_jumlah"]').val(count);
            trigger_total_php();
        } else {
    ...
    $('#id_php_dptb_laki_laki').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_php_dptb_perempuan').val());
        if ($(this).val().length) {
            $('input[id="id_php_dptb_jumlah"]').val(count);
            trigger_total_php();
        } else {
            $('input[id="id_php_dptb_jumlah"]').val(count);
            trigger_total_php();
    ...
    $('#id_php_dptb_perempuan').on('input', function () {
        var floor = Math.floor;
        var count = floor($(this).val()) + floor($('#id_php_dptb_laki_laki').val());
        if ($(this).val().length) {
            $('input[id="id_php_dptb_jumlah"]').val(count);
            trigger_total_php();
        } else {
