                ...
                <tr>
                    ...
                    <td>
                        <?php if ($val->img_thumb == '' or empty($val->img_thumb) or $val->img_thumb == NULL) { ?>
                            <img style="margin-top: -30px" width="320px" height="180px" src="<?php echo './uploads/data/ktp_contoh.png'; ?>">
                        <?php } else { ?>
                            <img style="margin-top: -30px" width="320px" height="180px" src="<?php echo './' . $val->img_thumb; ?>">
                        <?php } ?>
                    <td>
                </tr>
            <?php endforeach; ?>
