    ...
    <body lang=EN-ID>
        <table class="table_id">          
            <tr>
                ...
                <td>
                <td>
                    <?php if ($kta[0]->img_thumb == '' or empty($kta[0]->img_thumb) or $kta[0]->img_thumb == NULL) { ?>
                        <img style="margin-top: -10px" width="320px" height="180px" src="<?php echo './uploads/data/ktp_contoh.png'; ?>">
                    <?php } else { ?>
                        <img style="margin-top: -10px" width="320px" height="180px" src="<?php echo './' . $kta[0]->img_thumb; ?>">
                    <?php } ?>
                <td>
            </tr>
