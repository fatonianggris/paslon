...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Daftar Petugas</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Petugas Recruitment Anggota</a></li>
                <li class="breadcrumb-item active">Daftar Petugas Recruitment Anggota</li>
            </ol>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Daftar Petugas Recriuitment</h4>
                <h6 class="card-subtitle">Daftar petugas recruitment anggota terkait nama, status, alamat dll</h6>
                    ...
                    <table id="tabel_petugas" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>Email</th> 
                                <th>No. KTP</th>  
                                <th class="clear-td">Jumlah Anggota</th> 
                                <th>Kode</th>   
                                <th>No. HP</th>  
                ...
                <div class="modal-body">                  
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="<?php echo site_url('regional/'); ?>" class="btn btn-warning">KE DAFTAR REGIONAL Anggota</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#tabel_petugas').DataTable({
            ...
            //"serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('datatable/datatable/petugas_json'); ?>',
                "type": "POST"
            },
